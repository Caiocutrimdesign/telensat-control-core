...
const ecosystemServices = [
  { id: "plataforma", title: "Acionamento de Plataforma", icon: Truck, shortDesc: "Monitoramento e relatórios precisos de data, local e horário de uso da plataforma guincho.", img: "https://www.telensat.com.br/images/jpg/servicos/1.jpg", specs: ["Monitoramento 24/7", "Relatórios em tempo real", "Alerta de uso indevido"], details: "Sistema de monitoramento avançado para plataformas guincho, garantindo total visibilidade sobre o uso do equipamento e prevenindo desvios operacionais." },
  ...
  { id: "monitriip", title: "Sistema Monitriip ANTT", icon: FileCheck, shortDesc: "Homologado para envio em tempo real de dados para monitoramento interestadual.", img: "https://www.telensat.com.br/images/jpg/servicos/5.jpg", specs: ["Homologação ANTT", "Envio automático de dados", "Conformidade legal"], details: "Solução homologada para o envio de dados ao sistema Monitriip da ANTT, garantindo conformidade total com as exigências regulatórias para transporte interestadual." },
  ...
  { id: "satelital", title: "Comunicação Satelital", icon: Satellite, shortDesc: "Cobertura absoluta para veículos, barcos e máquinas agrícolas imunes a Jammer em toda LA.", img: "https://www.telensat.com.br/images/jpg/servicos/7.jpg", specs: ["100% Satelital", "Imune a Jammer", "Cobertura global"], details: "Solução de comunicação via satélite para operações em áreas remotas, garantindo conectividade ininterrupta e segurança contra bloqueadores de sinal (Jammers).", color: "accent" }
];
