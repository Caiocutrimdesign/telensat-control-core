...
const ecosystemServices = [
  ...
  { id: "porta-bau", title: "Porta Baú Inteligente", icon: PackageOpen, shortDesc: "Sensor que detecta abertura do baú em tempo real, alertando sobre acessos não autorizados durante a rota.", img: "/bau.jpeg", specs: ["Sensor magnético de alta precisão", "Alerta de abertura em local não autorizado", "Registro de eventos"], details: "Tecnologia de sensoriamento para baús, permitindo o controle total sobre a integridade da carga e prevenindo aberturas não autorizadas durante o trajeto." },
