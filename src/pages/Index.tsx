...
const ecosystemServices = [
  ...
  { id: "temperatura", title: "Gestão de Refrigeração", icon: Thermometer, shortDesc: "Monitoramento termométrico em tempo real com alertas de variação por tela e SMS.", img: "/plataforma.jpeg", specs: ["Monitoramento contínuo", "Alertas de variação térmica", "Relatórios de conformidade"], details: "Solução completa para transporte de carga perecível, garantindo que a temperatura se mantenha dentro dos parâmetros exigidos durante toda a operação." },
