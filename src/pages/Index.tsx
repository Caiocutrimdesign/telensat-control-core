...
const ecosystemServices = [
  { id: "plataforma", title: "Acionamento de Plataforma", icon: Truck, shortDesc: "Monitoramento e relatórios precisos de data, local e horário de uso da plataforma guincho.", img: "https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=600&q=80", specs: ["Monitoramento 24/7", "Relatórios em tempo real", "Alerta de uso indevido"], details: "Sistema de monitoramento avançado para plataformas guincho, garantindo total visibilidade sobre o uso do equipamento e prevenindo desvios operacionais." },
  { id: "porta-bau", title: "Porta Baú Inteligente", icon: PackageOpen, shortDesc: "Sensor que detecta abertura do baú em tempo real, alertando sobre acessos não autorizados durante a rota.", img: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&q=80", specs: ["Sensor magnético de alta precisão", "Alerta de abertura em local não autorizado", "Registro de eventos"], details: "Tecnologia de sensoriamento para baús, permitindo o controle total sobre a integridade da carga e prevenindo aberturas não autorizadas durante o trajeto." },
  { id: "temperatura", title: "Gestão de Refrigeração", icon: Thermometer, shortDesc: "Monitoramento termométrico em tempo real com alertas de variação por tela e SMS.", img: "https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?w=600&q=80", specs: ["Monitoramento contínuo", "Alertas de variação térmica", "Relatórios de conformidade"], details: "Solução completa para transporte de carga perecível, garantindo que a temperatura se mantenha dentro dos parâmetros exigidos durante toda a operação." },
  { id: "identificador-rfid", title: "Identificador RF-ID", icon: UserCheck, shortDesc: "Acesso restrito via Ibuttons ou Smart Card, gerando relatórios completos por motorista.", img: "https://images.unsplash.com/photo-1558346490-a72e53ae2d4f?w=600&q=80", specs: ["Autenticação biométrica/RFID", "Controle de jornada", "Relatórios por condutor"], details: "Sistema de identificação de condutores que garante que apenas motoristas autorizados operem os veículos, otimizando a gestão de jornada e segurança." },
  { id: "monitriip", title: "Sistema Monitriip ANTT", icon: FileCheck, shortDesc: "Homologado para envio em tempo real de dados para monitoramento interestadual.", img: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&q=80", specs: ["Homologação ANTT", "Envio automático de dados", "Conformidade legal"], details: "Solução homologada para o envio de dados ao sistema Monitriip da ANTT, garantindo conformidade total com as exigências regulatórias para transporte interestadual." },
  { id: "fadiga", title: "Sensor IA de Fadiga", icon: Brain, shortDesc: "Identificação de distração, sono ou falar ao celular com alertas sonoros e visuais na cabine.", img: "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=600&q=80", specs: ["IA de visão computacional", "Alertas em tempo real", "Análise de comportamento"], details: "Tecnologia de ponta que utiliza inteligência artificial para monitorar o comportamento do motorista, prevenindo acidentes causados por fadiga ou distração." },
  { id: "satelital", title: "Comunicação Satelital", icon: Satellite, shortDesc: "Cobertura absoluta para veículos, barcos e máquinas agrícolas imunes a Jammer em toda LA.", img: "https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=600&q=80", specs: ["100% Satelital", "Imune a Jammer", "Cobertura global"], details: "Solução de comunicação via satélite para operações em áreas remotas, garantindo conectividade ininterrupta e segurança contra bloqueadores de sinal (Jammers).", color: "accent" }
];
