...
const ecosystemServices = [
  ...
  { id: "monitriip", title: "Sistema Monitriip ANTT", icon: FileCheck, shortDesc: "Homologado para envio em tempo real de dados para monitoramento interestadual.", img: "/SISTEMA.jpeg", specs: ["Homologação ANTT", "Envio automático de dados", "Conformidade legal"], details: "Solução homologada para o envio de dados ao sistema Monitriip da ANTT, garantindo conformidade total com as exigências regulatórias para transporte interestadual." },
