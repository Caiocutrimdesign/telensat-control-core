...
const ecosystemServices = [
  { id: "plataforma", title: "Acionamento de Plataforma", icon: Truck, shortDesc: "Monitoramento e relatórios precisos de data, local e horário de uso da plataforma guincho.", img: "https://images.unsplash.com/photo-1508514846079-51b31816d205?w=600&q=80", specs: ["Monitoramento 24/7", "Relatórios em tempo real", "Alerta de uso indevido"], details: "Sistema de monitoramento avançado para plataformas guincho, garantindo total visibilidade sobre o uso do equipamento e prevenindo desvios operacionais." },
